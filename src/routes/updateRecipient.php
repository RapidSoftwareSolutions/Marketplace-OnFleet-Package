<?php
$app->post('/api/OnFleet/updateRecipient', function ($request, $response, $args) {
    $settings = $this->settings;

    //checking properly formed json
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['apiKey', 'name', 'phone', 'recipientId']);
    ...
    $query_str = $settings['api_url'] . "recipients/". $post_data['args']['recipientId'];
    $params = [
        'name' => 'name',
        'phone' => 'phone',
        'notes' => 'notes',
